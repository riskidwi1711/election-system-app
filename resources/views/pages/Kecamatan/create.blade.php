...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Tambah {{$title}}</h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a class="text-muted " href="index.html">Dashboard</a></li>
                        <li class="breadcrumb-item" aria-current="page">{{$title}}</li>
                        <li class="breadcrumb-item" aria-current="page">Tambah {{$title}}</li>
                    </ol>
                </nav>
            </div>
            <div class="col-3">
...
<div class="card w-100">
    <form method="POST" action="{{route($prefix.'.simpan')}}">
        @csrf
        <div class="card-body">
            <h5>Tambah {{$title}} baru</h5>
            <p class="card-subtitle mb-3">
                {{$title}} yang akan di tambahkan.
            </p>
            @error('*')
        ...
        <div class="card-body border-top">
            <div class="row">
                <div class="col-12">
                    <div class="mb-3">
                        <label for="isst" class="control-label col-form-label">Nama Kecamatan</label>
                        <input id="input-nama" name="nama" type="text" class="form-control" placeholder="Masukan nama kecamatan">
                    </div>
                </div>
                <div class="col-12">
                    <div class="mb-3">
                        <label for="isst" class="control-label col-form-label">Kode</label>

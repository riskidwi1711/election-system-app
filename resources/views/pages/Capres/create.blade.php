...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Tambah Data Calon Presiden & Wakil Presiden</h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a class="text-muted " href="index.html">Dashboard</a></li>
                        <li class="breadcrumb-item" aria-current="page">Data Calon Presiden & Wakil Presiden</li>
                        <li class="breadcrumb-item" aria-current="page">Tambah Data Calon Presiden & Wakil Presiden</li>
                    </ol>
                </nav>
            </div>
            <div class="col-3">
...
<div class="card w-100">
    <form method="POST" action="{{route('capres.simpan')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <h5>Tambah Calon Presiden & Wakil Presiden baru</h5>
            <p class="card-subtitle mb-3">
                Calon Presiden & Wakil Presiden akan di tambahkan sesuai dengan no urut.
            </p>
            @error('*')
                ...
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="isst" name="nama_wakil_presiden"
                            placeholder="Masukan nama calon Wakil Presiden">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="number" type="text" class="form-control" id="isst"
                            placeholder="Masukan no urut Calon Presiden & Wakil Presiden" name="no_urut">
                    </div>
                </div>
